...
-keep class com.tinyblack.book.widget.**{*;}
-keep class com.tinyblack.book.bean.**{*;}
-keep class com.tinyblack.book.api.**{*;}
-keep class android.support.**{*;}
...
-keep class com.tinyblack.book.presenter.impl.MainPresenterImpl{ *; }
