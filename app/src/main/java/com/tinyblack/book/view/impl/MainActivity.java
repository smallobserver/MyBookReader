...
import com.tinyblack.book.presenter.impl.MainPresenterImpl;
import com.tinyblack.book.presenter.impl.ReadBookPresenterImpl;
import com.tinyblack.book.view.IMainView;
import com.tinyblack.book.view.adapter.BookShelfAdapter;
import com.tinyblack.book.view.popupwindow.DownloadListPop;
import com.tinyblack.book.widget.refreshview.OnRefreshWithProgressListener;
...
public class MainActivity extends MBaseActivity<IMainPresenter> implements IMainView {
    ...
    protected void bindEvent() {
        ...
        ibLibrary.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivityByAnim(new Intent(MainActivity.this, SearchActivity.class), 0, 0);
            }
        });
