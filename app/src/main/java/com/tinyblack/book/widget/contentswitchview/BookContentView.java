package com.tinyblack.book.widget.contentswitchview;
...
import com.tinyblack.book.ReadBookControl;
import com.tinyblack.book.widget.MTextView;
        ...
        if (tag == qTag) {
            ...
            if (contentLines == null) {
                ...
                for (int i = 0; i < contentLines.size(); i++) {
                    String lineContent = contentLines.get(i);
                    s.append(lineContent);
                }
