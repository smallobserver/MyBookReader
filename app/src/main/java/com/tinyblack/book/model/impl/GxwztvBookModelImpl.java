...
import com.tinyblack.basemvplib.impl.BaseModelImpl;
...
import com.tinyblack.book.bean.WebChapterBean;
import com.tinyblack.book.cache.ACache;
import com.tinyblack.book.common.api.IGxwztvApi;
import com.tinyblack.book.ErrorAnalyContentManager;
...
import com.tinyblack.book.bean.LibraryKindBookListBean;
import com.tinyblack.book.listener.OnGetChapterListListener;
import com.tinyblack.book.model.IGxwztvBookModel;
        ...
        return Observable.create(new ObservableOnSubscribe<BookContentBean>() {
            ...
            public void subscribe(ObservableEmitter<BookContentBean> e) throws Exception {
                ...
                try {
                    ...
                    bookContentBean.setDurCapterContent(durChapterUrl.substring(0, durChapterUrl.indexOf('/', 8)) + "站点暂时不支持解析，请反馈给踹踹 QQ:394466706,无数天后解决，完全没有效率的程序员。");
