...
package com.tinyblack.book.view.adapter;
...
import com.tinyblack.book.widget.refreshview.RefreshRecyclerViewAdapter;
...
public class SearchBookAdapter extends RefreshRecyclerViewAdapter {
    ...
    public void onBindViewholder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        ((Viewholder) holder).tvAddShelf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (itemClickListener != null)
                    itemClickListener.clickAddShelf(((Viewholder) holder).ivCover, position, searchBooks.get(position));
            }
        });
    }
