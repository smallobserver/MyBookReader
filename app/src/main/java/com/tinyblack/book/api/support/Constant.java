 ...
 */
package com.tinyblack.book.api.support;

import android.graphics.Color;
import android.support.annotation.StringDef;

import com.tinyblack.book.api.support.util.AppUtils;
import com.tinyblack.book.api.support.util.FileUtils;
...
public class Constant {
    ...
    //暂时当作tag没用
    public static final String CHAPTER_BASE = "http://chapter2.zhuishushenqi.com/chapter/";
